...
////                    ///< 如果screen_w - achorX < popW，
////                    // 表示无法显示完全，则显示弹窗显示模式为RIGHTTOP_TO_LEFTBOTTOM
...
////                    ///< 如果(screenW - achorLocation[0] - achorW)< popW，
////                    // 表示无法显示完全，则显示弹窗显示模式为RIGHTTOP_TO_RIGHTBOTTOM
...
//                    break;
//                case FROM_RIGHT:
//                    basePop.showAtLocation(anchorView, Gravity.RIGHT | Gravity.CENTER_VERTICAL, 0, 0);
//                    break;
//            }
//            return this;
//        }
...
久保
5.9 done代码、对接SDK需求、
5.24、25、26 SDK安卓入口问题
5.30-6.7 消息跳转需求
6.19-26 需求
6.27 邮箱bug修复

5.9 获取代码，对接SDK需求，保险页与入口问题
5.24-5.26 SDK安卓入口问题
5.30-6.7 消息跳转需求
6.19-6.26 邮箱调整、
...
都保吧
6.13-15 done代码，对接需求（钱包调整）
6.19-20 需求（邮箱调整、轮播图调整）
6.28 邮箱图标
6.30 我的客户去除手机号栏
7.4-7.10 14、17 提现类型、按钮、金豆调整

[久保]    0509        接收代码、对接SDK需求
[久保]    0524        安卓SDK入口
[久保]    0530        消息跳转需求
[都保吧]   0613        接收代码
[都保吧]   0614        钱包调整需求
