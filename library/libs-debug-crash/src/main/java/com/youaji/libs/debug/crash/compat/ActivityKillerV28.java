package com.youaji.libs.debug.crash.compat;
...
public class ActivityKillerV28 implements IActivityKiller {
    ...
    private void finish(IBinder binder) throws Exception {
        ...
        // 获取 ActivityManagerService 类，简称AMS，拿到 finishActivity 方法
        // 第四个参数是：是否完成与此活动关联的任务。
        Method finishActivityMethod =
                managerClass.getDeclaredMethod("finishActivity", IBinder.class, int.class, Intent.class, int.class);
