package com.youaji.libs.debug.crash.reflection;

import static android.os.Build.VERSION.SDK_INT;
import static com.youaji.libs.debug.crash.reflection.BootstrapClass.exemptAll;
...
/**
 * 参考 <a href="https://github.com/tiann/FreeReflection">FreeReflection</a>
 * 一个允许你在Android P(包括Q和R)之上不受任何限制地使用反射的库。
 *
 * @author weishu
 * @date 2018/6/7.
 */
