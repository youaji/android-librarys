...
public final class AppFileSpUtils {

    private static final SimpleArrayMap<String, AppFileSpUtils> SP_UTILS_MAP = new SimpleArrayMap<>();
     ...
     * 获取 SP 实例
     *
     * @return {@link AppFileSpUtils}
     */
    public static AppFileSpUtils getInstance() {
        return getInstance("");
    }
     ...
     * @return {@link AppFileSpUtils}
     */
    public static AppFileSpUtils getInstance(String spName) {
        if (isSpace(spName)) spName = "spUtils";
        AppFileSpUtils spUtils = SP_UTILS_MAP.get(spName);
        if (spUtils == null) {
            spUtils = new AppFileSpUtils(spName);
            SP_UTILS_MAP.put(spName, spUtils);
        }
        return spUtils;
    }

    private AppFileSpUtils(final String spName) {
